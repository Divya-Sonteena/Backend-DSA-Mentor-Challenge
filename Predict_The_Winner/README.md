Predict the Winner – LeetCode # 486 problem 
...
- dp[i][j] represent the maximum score difference the current player can obtain from the subarray nums[i…j].
