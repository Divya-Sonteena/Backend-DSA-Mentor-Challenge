Task Scheduler – LeetCode # 621 problem
...
1. First, we count how many times each task appears.
2. maxFreq be the maximum frequency of any task.
3. countMax be the number of tasks that appear exactly maxFreq times.
